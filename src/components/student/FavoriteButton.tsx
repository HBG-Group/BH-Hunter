...
export function FavoriteButton({
  ...
  const base =
    variant === "overlay"
      ? "flex h-11 w-11 items-center justify-center rounded-full bg-white/85 backdrop-blur hover:bg-white"
      : "flex h-11 w-11 items-center justify-center rounded-full ring-1 ring-inset ring-neutral-200 hover:ring-neutral-300";
